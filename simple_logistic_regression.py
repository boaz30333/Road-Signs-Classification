...
def model():
    ...
    data_x = np.load("data/train__x.npy")  # dataX(features, r'dataset\train\[0-3]')
    print("datax: ", data_x)
    data_y = np.load("data/train__y.npy")  #dataY(categories, r'dataset\train\[0-3]')
    print("datay: ", data_y)
    data_x_test = np.load("data/test__x.npy")  #dataX(features, r'dataset\test\[0-3]')
    data_y_test = np.load("data/test__y.npy")  # dataY(categories, r'dataset\test\[0-3]')
